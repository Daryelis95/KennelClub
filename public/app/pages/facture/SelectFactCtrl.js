...
(function () {
  ...
  angular.module('BlurAdmin.pages.facture')
    .controller('SelectFactCtrl', SelectFactCtrl);

  /** @ngInject */
  function SelectFactCtrl($scope) {
    ...
    vm.standardSelectItems = [
      {label: '+ Nouveau Client', value: 1},
      {label: '+ Nouveau Société', value: 2},
      {label: 'Client', value: 3},
      {label: 'Société', value: 4},
    ...
    vm.groupedSelectItems = [
      {label: 'Jose Marín', value: 1, group: 'Client'},
      {label: 'Bodysano', value: 2, group: 'Société'},
      {label: 'Juan Francisco', value: 3, group: 'Client'},
      {label: 'Tuy Center Gym', value: 4, group: 'Société'}
    ];
